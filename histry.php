...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead text-white text-center">
                <h1 class="masthead-heading2 text-uppercase">Lihat History Perjalanan User menggunakan layanan GO-CAK</h1>
            </div>
        </header>
        <!-- Our Service Section-->
        <section class="page-section portfolio" id="OurService">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">History Pelanggan GO-CAK</h2>
                <!-- Icon Divider-->
...
echo"</thead>";
 $hasil = mysqli_query($conn,"SELECT login.username,stasiun.asal,stasiun.tujuan,stasiun.jarak,prosespesan.alamat,prosespesan.harga,prosespesan.bayar 
        FROM prosespesan INNER JOIN stasiun ON id_stas=stasiun_id INNER JOIN login ON id_name=user_id");
