...
<h1 class="masthead-heading1 text-uppercase">My Account</h1>
        <hr>
		...
		<div class="form-group">
        <a href="akunk.php" type="button" name="signup-btn" class="btn btn-primary btn-lg text-white">Edit Profil</a>
        </div>
</hr>
</form>
</div>
